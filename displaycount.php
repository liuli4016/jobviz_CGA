...
<div style="width:200px;">
   <div style="border:1px solid #000000;padding:2px;width:100%;font-size:120%;font-weight:bold;">
      <img src="displaycount.gif" width="18" height="18" border="0" /> Visitor Statistics 
   </div>

   <div style="border:1px solid #000000;padding:2px;width:100%;font-size:100%;">
   ...
   <div style="border:1px solid #000000;padding:2px;width:100%;font-size:120%;">
      Record: <?php echo $record_value; ?> (<?php echo date("Y-m-d", strtotime($record_date)) ?>)
   </div>
</div><?php
}
?>